...
public class CameraUtil {
    ...
    public void setSurfaceHolder(SurfaceHolder hodler) {
        try {
            mCamera.setPreviewDisplay(hodler);
...
//        计算最大视频比例
        ...
        Camera.Size pictureS = MyCamPara.getInstance().getPictureSize(previewSize, 800);
        mParameters.setPictureSize(pictureS.width, pictureS.height);
        mParameters.setPreviewSize(pictureS.width, pictureS.height);
