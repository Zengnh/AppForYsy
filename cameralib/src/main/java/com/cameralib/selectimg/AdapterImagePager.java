...
//                    .into(holder.videoView);
            holder.videoView.setImageBitmap(BitmapFactory.decodeFile(imageList.get(position).getPath()));
            ...
            holder.mPhotoView.setImageBitmap(BitmapFactory.decodeFile(imageList.get(position).getPath()));
//            Glide.with(context)
//                    .load(imageList.get(position).getPath())
//                    .error(R.mipmap.img_loading_err)
