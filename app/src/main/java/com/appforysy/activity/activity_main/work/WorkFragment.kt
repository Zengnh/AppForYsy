...
//        android:layout_width="wrap_content"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var tLayoutBack = view.findViewById<ImageView>(R.id.tLayoutBack)
        var tLayoutTitle = view.findViewById<TextView>(R.id.tLayoutTitle)
        tLayoutTitle.text = "解说"
        tLayoutTitle.visibility = View.VISIBLE
        tLayoutBack.visibility = View.GONE
    }
...
//    }
    ...
    fun mianShow() {
        val content =
            "getString(R.string.protocolAgree_info)getString(R.string.protocolAgree_info)getString(R.string.protocolAgree_info)"
