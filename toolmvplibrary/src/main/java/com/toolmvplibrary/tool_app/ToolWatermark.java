...
public class ToolWatermark {
    ...
    private static ToolWatermark sInstance;
 
    private ToolWatermark() {
        mText = "";
        mTextColor = 0x7dd2d2d2;//50%透明灰色
        mTextSize = 18;
        mRotation = -25;
    }
     ...
     * @return Watermark实例
     */
    public ToolWatermark setText(String text) {
        mText = text;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public ToolWatermark setTextColor(int color) {
        mTextColor = color;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public ToolWatermark setTextSize(float size) {
        mTextSize = size;
        return sInstance;
    }
     ...
     * @return Watermark实例
     */
    public ToolWatermark setRotation(float degrees) {
        mRotation = degrees;
        return sInstance;
    }
    ...
    private class WatermarkDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            mPaint.setTextSize(ToolSys.sp2px(activity,mTextSize)); // ConvertUtils.spToPx()这个方法是将sp转换成px，ConvertUtils这个工具类在我提供的demo里面有
